...
// ==================================================================================================================================
    adressItem: function(item, counter) {
        ...
        adressItem.innerHTML = `<input type="radio" name="modal-radio payment-modal-radio" id="radio${counter}">
                                <div class="d-flex jc-space-between">
                                    <label for="radio${counter}" class="radio-label delivery-radio-label d-flex ai-center cursor-pointer">
